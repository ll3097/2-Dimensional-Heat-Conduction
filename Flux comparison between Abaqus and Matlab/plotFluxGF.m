...
title('normal heat flux on boundary GF(comparison)')
hold on
SITA=0:sita/15:sita;
a=zeros(1,16);
for i=1:16
...
hold on
plot(SITA,E,'k*-','LineWidth',1.3);
legend('FE solution of normal heat flux in MATLAB','prescribed natural bc.','results of normal flux in ABAQUS')
grid on
